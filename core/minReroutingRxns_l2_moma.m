function [minRerouting] = minReroutingRxns_l2_moma(model,Jdl,cutOff,delta,Division)
...
%     fprintf('Finding minimal rerouting for pair: ( %s , %s )', Jdl(iLeth,1),Jdl(iLeth,2));
    ...
    [solutionDel1, solutionDel2, totalFluxDiff, solStatus] = quadraticMOMA_doubleKO(modelDel1, modelDel2, 'max');
