function [minRerouting] = minReroutingRxns_l2_moma(model, Jdl, obj_slack, cutOff, delta, Division)
%% [minRerouting] = minReroutingRxns_l2_moma(model, Jdl, obj_slack, cutOff)
% INPUT
...
%       diff_flux       The flux difference value obtained after L2-MOMA
%       abs_diff_flux   The abs flux difference value obtained after L2-MOMA
